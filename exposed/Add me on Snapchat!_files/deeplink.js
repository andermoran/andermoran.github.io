var IOS_APP_STORE = 'https://itunes.apple.com/us/app/snapchat/id447188370?mt=8';
...
function openIOSDeepLink(deepLink, noFallback) {
    openDeepLink(deepLink, noFallback ? null : IOS_APP_STORE);
}
